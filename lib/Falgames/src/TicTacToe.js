...
module.exports = class TicTacToe extends approve {
  ...
  constructor(options = {}) {
    ...
    if (!options.requestMessage)
      options.requestMessage = "{player} has invited you for a round of **Tic Tac Toe**.";
    if (!options.rejectMessage)
      options.rejectMessage = "The player denied your request for a round of **Tic Tac Toe**.";
