...
export default class WouldYouRather extends events {
  /**
  ...
  async gameOver(msg, result) {
    ...
    const prnt1 = Math.floor(
      (parseInt(this.data.option1Votes) /
        (parseInt(this.data.option1Votes) + parseInt(this.data.option2Votes))) *
        100,
    );
    const prnt2 = Math.floor(
      (parseInt(this.data.option2Votes) /
        (parseInt(this.data.option1Votes) + parseInt(this.data.option2Votes))) *
        100,
    );
