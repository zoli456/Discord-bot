...
export default class Minesweeper extends events {
  /**
  ...
  constructor(options = {}) {
    ...
    if (!options.winMessage)
      options.winMessage = "You won the Game! You successfully avoided all the mines.";
    if (!options.loseMessage)
      options.loseMessage = "You lost the Game! Beaware of the mines next time.";
