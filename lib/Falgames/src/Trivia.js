...
export default class Trivia extends events {
  /**
  ...
  constructor(options = {}) {
    ...
    if (!options.difficulty)
      options.difficulty = difficulties[Math.floor(Math.random() * difficulties.length)];
    ...
    if (this.options.mode === "multiple") {
      ...
      if (this.selected) {
        if (this.selected === "True")
          btn1.setStyle(this.selected === this.trivia.answer ? "SUCCESS" : "DANGER");
