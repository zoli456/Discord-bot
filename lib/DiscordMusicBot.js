...
const { TempChannelsManager, TempChannelsManagerEvents } = require("./Temp-Channels");
    ...
    this.manager
      ...
      .on("SegmentSkipped", (player, queue, payload) => {
        this.log(
          `${colors.blue(client.guilds.cache.get(player.options.guildId).name)}(${
            player.options.guildId
          }) | A ${payload.segment.category} segment has been skipped in a Youtube video. ${this.ms(
